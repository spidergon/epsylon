export default () => ({
  ...
  headerMenu: [
    { label: 'Cours en ligne', link: '/cours-en-ligne/' },
    { label: 'Corrections', link: '/corrections/' },
  ...
  data: {
    home: {
      hero: {
        ...
        action1: { label: 'Réserver un cours', link: '/cours-en-ligne/' },
        action2: { label: 'Commander une correction', link: '/corrections/' },
        img: '/img/hero.jpg',
        alt: 'matheuse portant livres',
      },
      about: {
        title: 'Bienvenue !',
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore quaerat sed, perferendis voluptatibus et ipsum est! Vitae quo maiores quis nisi eligendi sit quisquam dignissimos sequi ipsum alias? Earum, laudantium?</p>`,
        img: '/img/about.jpg',
        alt: "mains d'enfant en train d'écrire",
      },
      services: {
        ...
        items: [
          {
            ...
            action: { label: 'Réserver un cours en ligne', link: '/cours-en-ligne' },
          },
          {
            title: 'Correction des devoirs',
            text:
              'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.',
            action: { label: 'Commander une correction', link: '/corrections' },
          },
          {
            title: "Initiation à l'outil informatique",
            text:
              'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.',
            action: { label: "Réserver un cours d'informatique en ligne", link: '/cours-en-ligne' },
          },
          {
